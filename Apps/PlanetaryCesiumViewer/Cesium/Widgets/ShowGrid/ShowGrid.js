...
define([
     ...
     */
    var ShowGrid = function (IconsContainer, wrapperPanel, viewer) {

        var viewModel = new ShowGridViewModel(IconsContainer, wrapperPanel, viewer);
        ...
        gridButton.className = 'cesium-button cesium-toolbar-button cesium-modificationsToolbar-button';
        gridButton.innerHTML = '<svg width="305" height="305" viewBox="12.5 12.5 210 210">' + icone + ' </svg>';
    ...
    defineProperties(ShowGrid.prototype, {
        /**
