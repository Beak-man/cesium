...
define([
     ...
     */
    var Tools = function(container, viewer) {
		
		console.log("test tools");
		
		var viewModel  = new ToolsViewModel(container, viewer);	
		
		var wrench = '<path d=M86.257,23.405l-3.866,3.866l-3.737,3.737l-4.759,4.759c-2.521,0.161-5.096-0.713-7.023-2.64\
        ...
        toolButton.className     = 'cesium-button cesium-toolbar-button';                                                       
         toolButton.innerHTML = '<svg width="120" height="120" viewBox="50 10 210 210">'+wrench+' </svg>';             
        toolButton.setAttribute('data-bind', 'css: { "cesium-sceneModePicker-selected": dropDownVisible },\
				                                   attr: { title: tooltip }');
