...
define([
    ...
    function StereographicTilingScheme(options) {
       ...
       // this._projection = new GeographicProjection(this._ellipsoid); // projection calcul�e a partir de GeographicProjection ==> objet = {ellipsoid, semimajorAxis, 1/semimajorAxis}
        this._projection = new WebMercatorProjection(this._ellipsoid); // projection calcul�e a partir de GeographicProjection ==> objet = {ellipsoid, semimajorAxis, 1/semimajorAxis}
    ...
    return StereographicTilingScheme;
});
